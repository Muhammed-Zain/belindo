               ...
               <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    {(type === 'remove' || type === 'recolor') && (
                         <div className="prompt-field">
                              ...
                              {type === 'recolor' && (
                                   <CustomField control={form.control} name="color" formLabel="Replacement color" className="w-full" render={({ field }) => (<Input value={field.value} className="input-field" onChange={(e) => OnInputChangeHandler('color', e.target.value, 'recolor', field.onChange)} />)} />
                              )}
                         </div>
                    )}
